...
def test_create_wallet_duplicate(client):
    ...
    response = create_test_wallet(client)
    assert response.status_code == 409
    assert response.json() == {"detail": "Wallet name already exists for this account"}


def test_create_wallet_no_currency(client):
    create_test_account(client)
...
def test_create_wallet_invalid_currency(client):
    create_test_account(client)
...
def test_create_wallet_no_account(client):
    create_test_account(client)
    response = client.post(
        "/wallets/",
...
def test_create_wallet_invalid_account(client):
    create_test_account(client)
    response = client.post(
        "/wallets/",
...
def test_create_transaction_no_type(client):
    create_test_account(client)
    create_test_wallet(client)
    response = client.post(
        "/transactions/",
...
def test_create_transaction_no_description(client):
    create_test_account(client)
    create_test_wallet(client)
    response = client.post(
        "/transactions/",
...
def test_create_transaction_no_date(client):
    create_test_account(client)
    create_test_wallet(client)
    response = client.post(
        "/transactions/",
...
def test_create_flow_no_amount(client):
    create_test_account(client)
    create_test_wallet(client)
    create_test_transaction(client)
    response = client.post(
...
def test_create_flow_invalid_amount(client):
    create_test_account(client)
    create_test_wallet(client)
    create_test_transaction(client)
    response = client.post(
...
def test_create_flow_no_wallet(client):
    create_test_account(client)
    create_test_wallet(client)
    create_test_transaction(client)
    response = client.post(
...
def test_create_flow_invalid_wallet(client):
    create_test_account(client)
    create_test_wallet(client)
    create_test_transaction(client)
    response = client.post(
...
def test_create_flow_no_transaction(client):
    create_test_account(client)
    create_test_wallet(client)
    create_test_transaction(client)
    response = client.post(
...
def test_create_flow_invalid_transaction(client):
    create_test_account(client)
    create_test_wallet(client)
    create_test_transaction(client)
    response = client.post(
